...
export default {
  ...
  setup() {
    ...
    if (isUpdate.value) {
      store
        .dispatch("app-messages/fetchMessage", { id: router.currentRoute.params.id })
        .then((response) => {
    ...
    const onSubmit = () => {
      ...
      if (isUpdate.value) {
        store
          .dispatch("app-messages/updateMessage", {
            ...payload,
          ...
          .catch((e) => {
            if (e.response.data?.errors) {
              ...
              toast({
                component: ToastificationContent,
                props: {
                  title: "Erro na atualização de mensagem",
                  icon: "AlertTriangleIcon",
                  variant: "danger",
                  text: errors.join("\r\n"),
                },
        ...
        store
          .dispatch("app-messages/addMessage", payload)
          .then(() => {
            router.push({ name: "apps-messages" });
          })
          .catch((e) => {
            if (e.response.data?.errors) {
              ...
              toast({
                component: ToastificationContent,
                props: {
                  title: "Erro na criação de mensagem",
                  icon: "AlertTriangleIcon",
                  variant: "danger",
                  text: errors.join("\r\n"),
                },
