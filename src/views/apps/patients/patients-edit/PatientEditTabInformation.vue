      ...
      <b-row>
        ...
        >
          ...
          >
            <b-form-input
              id="mobile"
              v-model="patientDataInfo.mobile"
            />
          </b-form-group>
        </b-col>
        ...
        >
          ...
          >
            <b-form-input
              id="website"
              v-model="patientDataInfo.website"
            />
          </b-form-group>
        </b-col>
        ...
        >
          ...
          >
            <v-select
              v-model="patientDataInfo.language"
        ...
        >
          ...
          >
            <b-form-radio-group
              id="gender"
              v-model="patientDataInfo.gender"
        ...
        >
          ...
          >
            <b-form-checkbox-group
              id="contact-options"
              v-model="patientDataInfo.contactOptions"
      ...
      <b-row class="mt-1">
        ...
        >
          ...
          >
            <b-form-input
              id="address-line-1"
              v-model="patientDataInfo.addressLine1"
            />
          </b-form-group>
        </b-col>
        ...
        >
          ...
          >
            <b-form-input
              id="address-line-2"
              v-model="patientDataInfo.addressLine2"
        ...
        >
          ...
          >
            <b-form-input
              id="postcode"
              v-model="patientDataInfo.postcode"
              type="number"
              placeholder="597626"
            />
          </b-form-group>
        ...
        >
          ...
          >
            <b-form-input
              id="country"
              v-model="patientDataInfo.country"
